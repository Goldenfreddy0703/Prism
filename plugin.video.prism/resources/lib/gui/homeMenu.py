...
class Menus:
    ...
    def home():
        ...
        if g.get_setting('simkl.auth'):
            g.add_directory_item(
                ...
                menu_item=g.create_icon_dict("movies_simkl", g.ICONS_PATH),
            )
            g.add_directory_item(
                g.get_language_string(30003),
                action='myShows',
                description=g.get_language_string(30367),
                menu_item=g.create_icon_dict("shows_simkl", g.ICONS_PATH),
            )
            g.add_directory_item(
                g.get_language_string(30737),
                action='myAnime',
                description=g.get_language_string(30738),
                menu_item=g.create_icon_dict("anime_simkl", g.ICONS_PATH),
            )
        if g.my_files_available():
            g.add_directory_item(
    ...
    def search_menu():
        ...
        if g.get_bool_setting('searchHistory'):
            ...
            g.add_directory_item(
                g.get_language_string(30769),
                action='animeSearchHistory',
    ...
    def tools_menu():
        ...
        g.add_directory_item(
            ...
            action='simklSyncTools',
            is_folder=True,
            description=g.get_language_string(30384),
            menu_item=g.create_icon_dict("simkl", g.ICONS_PATH),
        )
        g.add_directory_item(
            'Download Manager',
    ...
    @staticmethod
    @simkl_auth_guard
    def simkl_sync_tools():
        g.add_directory_item(
            g.get_language_string(30216),
            action='flushSimklActivities',
            is_folder=False,
            description=g.get_language_string(30388),
            menu_item=g.create_icon_dict("simkl_reset", g.ICONS_PATH),
        )
        g.add_directory_item(
            g.get_language_string(30217),
            action='forceSimklSync',
            is_folder=False,
            description=g.get_language_string(30389),
            menu_item=g.create_icon_dict("simkl_sync", g.ICONS_PATH),
        )
        g.add_directory_item(
            g.get_language_string(30218),
            action='rebuildSimklDatabase',
            is_folder=False,
            description=g.get_language_string(30390),
            menu_item=g.create_icon_dict("simkl_rebuild", g.ICONS_PATH),
        )
        g.close_directory(g.CONTENT_MENU)
    ...
    def test_windows():
        ...
        g.add_directory_item(
            g.get_language_string(30818),
            action='testSkipSegment',
            is_folder=False,
            description=g.get_language_string(30819),
            menu_item=g.create_icon_dict("test", g.ICONS_PATH),
        )
        g.add_directory_item(
            g.get_language_string(30823),
            action='testSkipOutro',
            is_folder=False,
            description=g.get_language_string(30824),
            menu_item=g.create_icon_dict("test", g.ICONS_PATH),
        )
        g.add_directory_item(
